...
if __name__ == '__main__':
    ...
    plt.plot(signals[0,2000::], color="green", linestyle='-', marker='.', markersize=5, label="Ref")
    plt.plot(signals[1,2000::], color="blue", linestyle='-', marker='.', markersize=5, label="OA")
    plt.plot(signals[2,2000::], color="orange", linestyle='-', marker='.', markersize=5, label="CA")
