...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_measurementParams.addWidget(self.labe_geomSampleLength, 4, 0, 1, 1)
        ...
        self.gridLayout_measurementParams.addWidget(self.doubleSpinBox_geomSampleLength, 4, 1, 1, 1)
        self.label_alpha = QtWidgets.QLabel(self.groupBox4Notes)
        self.label_alpha.setObjectName("label_alpha")
        self.gridLayout_measurementParams.addWidget(self.label_alpha, 4, 3, 1, 1)
        self.doubleSpinBox_alpha = QtWidgets.QDoubleSpinBox(self.groupBox4Notes)
        self.doubleSpinBox_alpha.setMaximum(1000.0)
        self.doubleSpinBox_alpha.setObjectName("doubleSpinBox_alpha")
        self.gridLayout_measurementParams.addWidget(self.doubleSpinBox_alpha, 4, 4, 1, 1)
        ...
        self.label_RefrIndexMaterial = QtWidgets.QLabel(self.widgetRefractiveIndexCalibrateBtn)
        self.label_RefrIndexMaterial.setObjectName("label_RefrIndexMaterial")
        self.gridLayout_refrIndexes.addWidget(self.label_RefrIndexMaterial, 0, 0, 1, 1)
        self.doubleSpinBox_refrIndexMaterial = QtWidgets.QDoubleSpinBox(self.widgetRefractiveIndexCalibrateBtn)
        ...
        self.gridLayout_refrIndexes.addWidget(self.doubleSpinBox_refrIndexMaterial, 0, 1, 1, 1)
        self.label_RefrIndexAmbient = QtWidgets.QLabel(self.widgetRefractiveIndexCalibrateBtn)
        self.label_RefrIndexAmbient.setObjectName("label_RefrIndexAmbient")
        self.gridLayout_refrIndexes.addWidget(self.label_RefrIndexAmbient, 1, 0, 1, 1)
        self.doubleSpinBox_refrIndexAmbient = QtWidgets.QDoubleSpinBox(self.widgetRefractiveIndexCalibrateBtn)
        ...
        self.gridLayout_refrIndexes.addWidget(self.doubleSpinBox_refrIndexAmbient, 1, 1, 1, 1)
