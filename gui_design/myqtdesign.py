...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_effLength = QtWidgets.QLabel(self.widgetAlphaValue)
        self.label_effLength.setObjectName("label_effLength")
        self.gridLayout_2.addWidget(self.label_effLength, 5, 3, 1, 1)
        self.label_effLengthValue = QtWidgets.QLabel(self.widgetAlphaValue)
        self.label_effLengthValue.setObjectName("label_effLengthValue")
        self.gridLayout_2.addWidget(self.label_effLengthValue, 5, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_effLength.setText(_translate("MainWindow", "<html><head/><body><p>L<span style=\" vertical-align:sub;\">eff</span> / mm =</p></body></html>"))
        self.label_effLengthValue.setText(_translate("MainWindow", "1.00"))
